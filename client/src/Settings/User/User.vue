<template>
  <div>
    ...
    <div>
      ...
      <b-modal id="change-my-password-modal" title="Change Password" size="lg">
        <change-my-password ref="changeMyPassword" :id="user.id"></change-my-password>
          ...
          <div class="w-100">
            <div class="float-right">
              <b-button
                  variant="danger"
                  class="mr-2"
                  @click="$bvModal.hide('change-my-password-modal')"
      ...
      <b-modal id="change-my-pin-modal" title="Change PIN" size="lg">
        <change-my-pin ref="changeMyPin" :id="user.id"></change-my-pin>
        <template v-slot:modal-footer>
          <div class="w-100">
            <div class="float-right">
              <b-button
                  variant="danger"
                  class="mr-2"
                  @click="$bvModal.hide('change-my-pin-modal')"
...
<script>
  ...
  import ChangeMyPassword from '@/Settings/User/ChangeMyPassword'
  import ChangeMyPin from '@/Settings/User/ChangeMyPin'
  ...
  export default {
    ...
    methods: {
      ...
      update() {
        ...
        this.form.patch('/api/settings/user')
            .then(data => {
      ...
      updatePassword() {
        ...
        this.$refs.changePassword.submit()
            .then(data => {
              ...
              this.$bvModal.hide('change-my-password-modal')
            })
            .catch(data => {
              console.error(data.message)
              this.isUpdatingPassword = false
      ...
      updatePin() {
        ...
        this.$refs.changePin.submit()
            .then(data => {
              ...
              this.$bvModal.hide('change-my-pin-modal')
            })
            .catch(data => {
              console.error(data.message)
              this.isUpdatingPin = false
